...
export default function About() {
    ...
    return(
        <section className='flex flex-col items-center gap-4 p-5'>
            <span className='font-bold text-4xl flex text-third'>Who am I?</span>   
            <div className='flex gap-4 flex-col items-center max-w-6xl md:items-start md:flex-row '>
                ...
                <div className='flex flex-col'>
                    <span className='text-xl font-light text-headline leading-normal'>
                    <m.p
                        initial={{y:100, opacity:0}}
                        whileInView={{y:0, opacity:1}}
                        viewport={{once:true}}
                    ...
                    className='mt-3'>I have always been fascinated by the power of technology and how it can help people solve problems, 
                    ...
                    <m.p 
                        ...
                        viewport={{once:true}}
                        transition={{opacity:{duration:1.5}, y:{duration:1.5}}}
                    className='mt-3'>I graduated in 2021 with a degree in Production Engineering, which has given me a solid foundation 
                    ...
                    className='mt-3'>With my passion for programming and my process knowledge, 
                    ...
                    viewport={{once:true}}
                    transition={{opacity:{duration:1.5}, y:{duration:1.5}}}
                    className='mt-3'>I'm a self-development enthusiast, always trying to keep my mind 
                    and body as healthy as possible.</m.p></span> 
                </div>
            </div> 
